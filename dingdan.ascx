<%@ Control Language="C#" AutoEventWireup="true" CodeFile="dingdan.ascx.cs" Inherits="dingdan" %>
    ...
    <ItemTemplate>
        <div class="row mb-3">
            ...
            <div class="col-md-9" style="border-bottom: 1px solid #ccc;">
                ...
                <div class="clearfix"></div>
                <asp:Button runat="server" CssClass="btn btn-success btn-sm float-right" ID="btnDel" Text='<%# DataBinder.Eval(Container.DataItem,"状态") %>' />
